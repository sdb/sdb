...
class Service(models.Model):
  ...
  args = sdb_models.DictionaryField(max_length=1023)
  props = sdb_models.DictionaryField(max_length=1023, blank=True)
...
class Entry(models.Model):
  ...
  data = sdb_models.DictionaryField(max_length=30000)
